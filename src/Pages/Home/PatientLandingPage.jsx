// src/Pages/landing/PatientLandingPage.js
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <section className="text-center py-12 bg-white">
        <h1 className="text-4xl font-bold text-indigo-600 mb-4">Welcome to MedEase</h1>
      ...
      <section className="bg-indigo-600 text-white text-center py-12">
        ...
        <Link
          to="/appointments"
          className="bg-white text-indigo-600 py-3 px-6 rounded-md hover:bg-gray-100"
        >
          Get Started
        </Link>
      </section>
